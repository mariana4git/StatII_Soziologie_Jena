...
\caption{\colorbox{yellow!40}{Es gibt ein Aufgabenblatt zur Abgabe}}
  ...
  Varianzanalyse} \\ % LM S. 234
                   &        & \colorbox{violet!40}{und lineare Regression (F-Test)}\\ \hline  
                   \multirow{2}{*}{\colorbox{yellow!40}{5}} &  \multirow{2}{*}{$08.01.2018$}& \colorbox{violet!40}{Multiple lineare Regression:} \\ % LM S. 234
                   &        & \colorbox{violet!40}{Modellannahmen und Regressionsdiagnostik}\\ \hline 
   % \colorbox{yellow!40}{5} & $08.01.2018$      &  \colorbox{violet!40}{Multiple lineare Regression: Modellannahmen und Regressionsdiagnostik}  \\ \hline   
...
\item {Sie müssen bei vier von fünf Aufgabenblättern mindestens $50\%$ richtig gelöst haben, um an der Klausur teilnehmen zu dürfen.}\pause
  \item {Die Klausur findet am Montag den 19. Februar um 10-12 Uhr statt.}\pause
  \item {Die Nachholklausur findet am Montag den 19. März um 10-12 Uhr statt.}\pause
...
%\\ \colorbox{yellow!40}{\url{wiwi_formelsammlung_statistik_b28.pdf}}
\end{frame}
