...
\section{Ausblick Übung: Probleme aus dem letzten Semestern mit den neuen Werkzeugen lösen}% FT S. 433
...
\item{Wir werden auch den einfachen t-Test am Beispiel der PISA-Daten behandeln.} %LM S.164
\end{itemize}
\end{frame}
